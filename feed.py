...
with open('feed.yaml', 'r') as file:
    ...
    rss_element = xml_tree.Element('rss',{
        ...
        'xmlns:content': 'http://purl.org/rrs/1.0/modules/content/'
    })
...
for item in yaml_data['item']:
    ...
    enclosure = xml_tree.SubElement(item_element, 'enclosure',{'length':item['length'], 'type': 'audio/mpeg', 'url': yaml_data['link']+item['file']})
